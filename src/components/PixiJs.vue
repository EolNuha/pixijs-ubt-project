...
<template>
  <div class="pixiJs">
    ...
    <div>
      <h1>Pixi.js Library</h1>
      <p>
        PixiJS is an open source, web-based rendering system that provides blazing fast performance
        for games, data visualization, and other graphics intensive projects.
      </p>
    </div>
  </div>
</template>
